...
static const u32 tegra_kbc_atrix_keymap[] __devinitdata = {
...
static const
struct matrix_keymap_data tegra_kbc_atrix_keymap_data __devinitdata = {
        .keymap         = tegra_kbc_atrix_keymap,
        .keymap_size    = ARRAY_SIZE(tegra_kbc_atrix_keymap),
};
...
static int __devinit tegra_kbc_probe(struct platform_device *pdev)
{
	...
	keymap_data = pdata->keymap_data ?: &tegra_kbc_phone_keymap_data;
